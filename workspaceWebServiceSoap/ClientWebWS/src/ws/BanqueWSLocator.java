...
public class BanqueWSLocator extends org.apache.axis.client.Service implements ws.BanqueWS {
    ...
    public ws.BanqueService getBanqueServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            ws.BanqueServicePortBindingStub _stub = new ws.BanqueServicePortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ws.BanqueService.class.isAssignableFrom(serviceEndpointInterface)) {
                ws.BanqueServicePortBindingStub _stub = new ws.BanqueServicePortBindingStub(new java.net.URL(BanqueServicePort_address), this);
                _stub.setPortName(getBanqueServicePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://ws/", "BanqueWS");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://ws/", "BanqueServicePort"));
        }
